...
public class EuroCurrency extends AbstractFactory {
	
	private static final Logger log = LoggerFactory.getLogger(EuroCurrency.class);

	@Override
	public void getCurrency(Double amount, List<CurrencyEntity> currencyList,
			Map<String, Object> responseMap) {
		log.info("Inside EuroCurrency class, getCurrency method");
		int count = 0;
